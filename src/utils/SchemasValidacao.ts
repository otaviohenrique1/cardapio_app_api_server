...
export const valida_lista_produtos = Yup
  .array(
    Yup
      .object()
      .shape({
...
export const valida_criacao_pedido = Yup
  ...
  .shape({
    ...
    lista_produtos: valida_lista_produtos,
    data_cadastro: valida_data_cadastro,
    data_modificacao_cadastro: valida_data_modificacao_cadastro,
  });
...
export const valida_criacao_produto = Yup
  .object()
  .shape({
    nome: valida_nome,
    preco: valida_preco,
...
export const valida_alualizacao_produto = Yup
  .object()
  .shape({
    nome: valida_nome,
    preco: valida_preco,
