...
import { coluna_removivel, coluna_nome, coluna_primary_key, coluna_quantidade, coluna_produtoId, coluna_unidade_quantidade, if_table_not_exist } from "../utils/constantes_migration";
